    ...
    <div class="block">
        <div class="block__content">
            ...
            <div class="block__question">
                <span class="qusteion-title">Вопрос №14</span>
                <br>
                <div class="triangle-left"></div>
                <span class="question">{{ $store.state.quiz.questions[13].question }}</span>
            ...
            <div class="answers">
                ...
                <div class="bottom-answers">
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[13].thirdAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[13].fourthAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                </div>
