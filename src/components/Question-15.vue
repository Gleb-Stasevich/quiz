    ...
    <div class="block">
        <div class="block__content">
            ...
            <div class="block__question">
                <span class="qusteion-title">Последний вопрос</span>
                <br>
                <div class="triangle-left"></div>
                <span class="question">{{ $store.state.quiz.questions[14].question }}</span>
            ...
            <div class="answers">
                ...
                <div class="bottom-answers">
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[14].thirdAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[14].fourthAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                </div>
    ...
    methods: {
        ...
        checkAnswer(elem) {
            ...
            setTimeout(() => {
                ...
                if (this.$store.state.quiz.totalAnswers > 15 || this.$store.state.quiz.rightAnswers > 15) {
                    this.$router.push('/not-fair-game');
                } else {
