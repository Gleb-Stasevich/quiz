    ...
    <div class="block">
        <div class="block__content">
            ...
            <div class="block__question">
                <span class="qusteion-title">Вопрос №4</span>
                <br>
                <div class="triangle-left"></div>
                <span class="question">{{ $store.state.quiz.questions[3].question }}</span>
                <div class="triangle-right"></div>
            </div>
            <img src="@/../public/img/question-4.png" alt="">
            <div class="answers">
                <div class="top-answers">
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[3].firstAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                    <div @click="checkAnswer" class="answer correct-answer">
                        {{ $store.state.quiz.questions[3].secondAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                </div>
                <div class="bottom-answers">
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[3].thirdAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                    <div @click="checkAnswer" class="answer">
                        {{ $store.state.quiz.questions[3].fourthAnswer }}
                        <div class="answer-left-triangle"></div>
                        <div class="answer-right-triangle"></div>
                    </div>
                </div>
